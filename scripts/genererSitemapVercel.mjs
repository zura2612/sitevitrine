// fichier scripts/genererSitemapVercel.mjs
...
const SITE_URL = process.env.SITE_URL_VERCEL;
const OUTPUT_PATH = process.env.OUTPUT_PATH_VERCEL;

if (!SITE_URL || !OUTPUT_PATH) {
  console.error('❌ Variables d\'environnement manquantes :');
  console.error('  - SITE_URL_VERCEL:', SITE_URL);
  console.error('  - OUTPUT_PATH_VERCEL:', OUTPUT_PATH);
  process.exit(1);
}
